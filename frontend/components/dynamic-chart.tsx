...
const colors = [
  "hsl(215, 70%, 50%)", // Deep blue
  "hsl(152, 55%, 45%)", // Emerald green
  "hsl(355, 65%, 55%)", // Ruby red
  "hsl(45, 70%, 50%)", // Amber gold
  "hsl(260, 50%, 55%)", // Purple
  "hsl(190, 65%, 45%)", // Teal
  "hsl(20, 75%, 55%)", // Pumpkin orange
  "hsl(320, 60%, 45%)", // Magenta
];
...
export function DynamicChart({
  ...
  const [containerRef, endRef, scrollToBottom] = useScrollToBottom(false);
